...
A curated list of [Capture The Flag](https://en.wikipedia.org/wiki/Capture_the_flag_(cybersecurity)) (CTF) frameworks, libraries, resources, softwares and tutorials. This list aims to help starters as well as seasoned CTF players to find everything related to CTFs at one place.
